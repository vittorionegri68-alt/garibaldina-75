      ...
      <div style={innerStyle}>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '28px' }} className="desktop-nav">
          ...
          <div style={switcherStyle}>
            ...
            <span style={{ fontWeight: 700, fontSize: '0.8rem', color: 'var(--color-accent)' }}>EN</span>
          </div>
        </div>
      ...
      {menuOpen && (
        <div style={{
          ...
          <div style={{ display: 'flex', gap: '8px' }}>
            <a href={config.langIT} style={{ fontWeight: 500, fontSize: '0.85rem', color: 'var(--color-muted)' }}>IT</a>
            <span style={{ color: 'var(--color-muted)' }}>|</span>
            <span style={{ fontWeight: 700, fontSize: '0.85rem', color: 'var(--color-accent)' }}>EN</span>
          </div>
        </div>
      )}
