      ...
      <div style={style.inner}>
        <div style={style.grid}>
          <div>
            ...
            <p style={{ fontSize: '0.875rem', lineHeight: '1.7', maxWidth: '240px' }}>
              A modern apartment in the centre of Cesena. Lucea Collection.
            </p>
          </div>
          <div>
            <div style={style.heading}>Navigation</div>
            <a href="#apartment" style={style.link}>{t.nav.appartamento}</a>
            <a href="#experience" style={style.link}>{t.nav.esperienza}</a>
            <a href="#how-to-book" style={style.link}>{t.nav.comeFunziona}</a>
            <a href="#reviews" style={style.link}>{t.nav.recensioni}</a>
            <a href="#location" style={style.link}>{t.nav.posizione}</a>
          </div>
          <div>
            <div style={style.heading}>Contact</div>
          ...
          <div>
            <div style={style.heading}>Romagna Short Stay</div>
        ...
        <div style={style.bottom}>
          ...
          <div style={style.switcher}>
            <a href={config.langIT} style={{ color: 'rgba(255,255,255,0.4)', fontWeight: 500 }}>IT</a>
            <span>|</span>
            <span style={{ fontWeight: 700, color: 'var(--color-accent)' }}>EN</span>
          </div>
        </div>
      </div>
    </footer>
